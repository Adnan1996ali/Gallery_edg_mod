...
data class Model(
   ...
   * - `alpha.ai.chat` for builds from the GitHub source.
   * - `alpha.ai.chat` for other builds (Play store, internal, etc).
   *
   ...
   *
   * /storage/emulated/0/Android/data/alpha.ai.chat/files/my_model/local_dir/
   *

...
package alpha.ai.chat.ui.common.chat

// import alpha.ai.chat.ui.preview.PreviewChatModel
// import alpha.ai.chat.ui.preview.PreviewModelManagerViewModel
// import alpha.ai.chat.ui.preview.TASK_TEST1
// import alpha.ai.chat.ui.theme.GalleryTheme
...
import alpha.ai.chat.ui.common.copyBitmapToClipboard
import alpha.ai.chat.ui.common.saveBitmapToMediaStore
import alpha.ai.chat.ui.common.shareBitmap
...
/**
 * Deserializes a list of [alpha.ai.chat.proto.ChatMessageProto] from persistent
...
private fun deserializeProtoMessages(
  protoMessages: List<alpha.ai.chat.proto.ChatMessageProto>
): List<ChatMessage> {
  return protoMessages.mapNotNull { protoMsg ->
    val side =
      when (protoMsg.side) {
        alpha.ai.chat.proto.ChatSideProto.CHAT_SIDE_USER -> ChatSide.USER
        alpha.ai.chat.proto.ChatSideProto.CHAT_SIDE_MODEL -> ChatSide.AGENT
        alpha.ai.chat.proto.ChatSideProto.CHAT_SIDE_SYSTEM -> ChatSide.SYSTEM

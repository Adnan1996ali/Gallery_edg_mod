...
package alpha.ai.chat.ui.modelmanager
...
import alpha.ai.chat.AppLifecycleProvider
import alpha.ai.chat.BuildConfig
import alpha.ai.chat.R
import alpha.ai.chat.common.ProjectConfig
import alpha.ai.chat.common.SystemPromptHelper
import alpha.ai.chat.common.getJsonResponse
import alpha.ai.chat.common.isAICoreSupported
import alpha.ai.chat.customtasks.common.CustomTask
import alpha.ai.chat.data.Accelerator
import alpha.ai.chat.data.BuiltInTaskId
import alpha.ai.chat.data.Category
import alpha.ai.chat.data.CategoryInfo
import alpha.ai.chat.data.Config
import alpha.ai.chat.data.ConfigKeys
import alpha.ai.chat.data.DataStoreRepository
import alpha.ai.chat.data.DownloadRepository
import alpha.ai.chat.data.EMPTY_MODEL
import alpha.ai.chat.data.IMPORTS_DIR
import alpha.ai.chat.data.Model
import alpha.ai.chat.data.ModelAllowlist
import alpha.ai.chat.data.ModelCapability
import alpha.ai.chat.data.ModelDownloadStatus
import alpha.ai.chat.data.ModelDownloadStatusType
import alpha.ai.chat.data.NumberSliderConfig
import alpha.ai.chat.data.RuntimeType
import alpha.ai.chat.data.SOC
import alpha.ai.chat.data.SystemPromptRepository
import alpha.ai.chat.data.TMP_FILE_EXT
import alpha.ai.chat.data.Task
import alpha.ai.chat.data.ValueType
import alpha.ai.chat.data.createLlmChatConfigs
import alpha.ai.chat.proto.AccessTokenData
import alpha.ai.chat.proto.ImportedModel
import alpha.ai.chat.proto.Theme
import alpha.ai.chat.runtime.aicore.AICoreModelHelper

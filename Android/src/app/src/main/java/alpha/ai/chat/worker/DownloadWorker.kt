...
import alpha.ai.chat.data.KEY_MODEL_COMMIT_HASH
import alpha.ai.chat.data.KEY_MODEL_DOWNLOAD_ACCESS_TOKEN
import alpha.ai.chat.data.KEY_MODEL_DOWNLOAD_ERROR_MESSAGE
import alpha.ai.chat.data.KEY_MODEL_DOWNLOAD_FILE_NAME
import alpha.ai.chat.data.KEY_MODEL_DOWNLOAD_MODEL_DIR
import alpha.ai.chat.data.KEY_MODEL_DOWNLOAD_RATE
import alpha.ai.chat.data.KEY_MODEL_DOWNLOAD_RECEIVED_BYTES
import alpha.ai.chat.data.KEY_MODEL_DOWNLOAD_REMAINING_MS
import alpha.ai.chat.data.KEY_MODEL_EXTRA_DATA_DOWNLOAD_FILE_NAMES
import alpha.ai.chat.data.KEY_MODEL_EXTRA_DATA_URLS
import alpha.ai.chat.data.KEY_MODEL_IS_IMPORTED
import alpha.ai.chat.data.KEY_MODEL_IS_ZIP
import alpha.ai.chat.data.KEY_MODEL_NAME
import alpha.ai.chat.data.KEY_MODEL_START_UNZIPPING
import alpha.ai.chat.data.KEY_MODEL_TOTAL_BYTES
import alpha.ai.chat.data.KEY_MODEL_UNZIPPED_DIR
import alpha.ai.chat.data.KEY_MODEL_URL
...
class DownloadWorker(context: Context, params: WorkerParameters) :
  ...
  private fun createForegroundInfo(progress: Int, modelName: String? = null): ForegroundInfo {
    ...
    val intent =
      Intent(applicationContext, Class.forName("alpha.ai.chat.MainActivity")).apply {
